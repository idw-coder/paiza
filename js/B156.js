  ...
  while (
    ...
    if (direction_of_travel === 0) {
      ...
      for (let i = start_point.left; i <= start_point.right; i++) {
        ...
        logContent += '→ ' + start_point.top + ' ' + i + ' ' + inputArray[start_point.top][i] + '\n'
      }
      start_point.top++
      direction_of_travel++
      logContent +=
      ...
      for (let i = start_point.top; i <= start_point.bottom; i++) {
        ...
        logContent +=
          '↓ ' + i + ' ' + start_point.right + ' ' + inputArray[i][start_point.right] + '\n'
      }
      start_point.right--
      direction_of_travel++
      logContent +=
      ...
      for (let i = start_point.right; i >= start_point.left; i--) {
        ...
        logContent +=
          '← ' + start_point.bottom + ' ' + i + ' ' + inputArray[start_point.bottom][i] + '\n'
      }
      start_point.bottom--
      direction_of_travel++
      logContent +=
      ...
      for (let i = start_point.bottom; i >= start_point.top; i--) {
        ...
        logContent +=
          '↑ ' + i + ' ' + start_point.left + ' ' + inputArray[i][start_point.left] + '\n'
      }
      start_point.left++
