...
function solve(N, X, list) {
    ...
    for (let item_1 = 0; item_1 < N; item_1++) {
        ...
        if (totalV1 === X)
            resultList.item_1 = Math.max(resultList.item_1, list[item_1][1]);
        for (let item_2 = item_1 + 1; item_2 < N; item_2++) {
            ...
            for (let item_3 = item_2 + 1; item_3 < N; item_3++) {
                ...
                if (totalV3 === X)
                    resultList.item_3 = Math.max(resultList.item_3, list[item_1][1] + list[item_2][1] + list[item_3][1]);
            }
        }
    }
...
//# sourceMappingURL=260923_B152.js.map