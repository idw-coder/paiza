...
function solve(sX, sY, d_f, d_r, d_b, d_l, cList) {
    let currFace = '+Y';
...
reader.on('close', () => {
    const [sX, sY] = lines[0].split(' ').map(Number);
...
//# sourceMappingURL=260921_B034.js.map